...
{
    // Single Inheritance
    std::cout<<"The below is an example of Single Inheritance"<<std::endl;
    Developer dev("Ramu Kaka", 101, "C++");
    dev.show();

    // // Multiple Inheritance
    cout<<"The below is an example of Multiple Inheritance"<<endl;
    TechLead techLead("Anna Dev", 202, "Project X", 5);
    techLead.displayInfo();

    // // Multi-level Inheritance
    cout<<"The below is an example of Multi-level Inheritance"<<endl;
    HRDirector hrDirector("Lucy Madam", 303);
    hrDirector.handleHRDuties();
    hrDirector.manageHRDepartment();

    // Hierarchical Inheritance
    cout<<"The below is an example of Hierarchial Inheritance"<<endl;
    CEO ceo("Devi Lal", 404);
    ceo.leadCompany();

    // // Hybrid Inheritance
    cout<<"The below is an example of Hybrid Inheritance"<<endl;
